...
<a name="method-copy-from"></a>
####copyFrom(<em>string<em> queryText):[WritableStream](http://nodejs.org/api/all.html#all_writable_stream) 
...
<a name="method-copy-to"></a>
####copyTo(<em>string</em> queryText):[ReadableStream](http://nodejs.org/api/all.html#all_readable_stream) 
